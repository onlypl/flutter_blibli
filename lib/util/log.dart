...
class PLogOutput extends LogOutput {
  @override
...
class Log{
  final _logger = Logger(
   ...
   void verbose(dynamic message, [DateTime? time,Object? error, StackTrace? stackTrace]) {
  ...
  void warn(dynamic message, [DateTime? time,Object? error, StackTrace? stackTrace]) {
  ...
  void fatal(dynamic message, [DateTime? time,Object? error, StackTrace? stackTrace]) {
